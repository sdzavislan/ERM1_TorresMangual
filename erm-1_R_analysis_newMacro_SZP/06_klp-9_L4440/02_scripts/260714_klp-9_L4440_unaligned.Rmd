...
## Generate .csv of max intensities for erm-1 in klp-9 KD and L4440 control
...
write_csv(max_intensities, "klp-9_L4440_ch2_max_intensities.csv")
```
...
d <- ggplot(data = foldChange_calc, aes(x = as.factor(channel), y = log(fc_enrich, base = 2), fill = treatment))+
  ...
  scale_fill_manual(values = c("L4440" = "darkgray", "klp-9" = "lightblue"),
                   labels = c("L4440" = "L4440 control", "klp-9" = "klp-9 RNAi"))+
