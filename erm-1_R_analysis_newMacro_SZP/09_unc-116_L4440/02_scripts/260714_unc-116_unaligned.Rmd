...
rnai_data_total <- rbind(control_1_plustime, control_2_plustime, control_3_plustime, test_1_plustime, test_2_plustime, test_3_plustime, test_4_plustime)
...
## Generate .csv of max intensities for erm-1 in unc-116 KD and L4440 control
...
write_csv(max_intensities, "unc-116_L4440_ch2_max_intensities.csv")
```
...
d <- ggplot(data = foldChange_calc, aes(x = as.factor(channel), y = log(fc_enrich, base = 2), fill = treatment))+
  ...
  scale_fill_manual(values = c("L4440" = "darkgray", "unc-116" = "lightblue"),
                   labels = c("L4440" = "L4440 control", "unc-116" = "unc-116 RNAi"))+
