...
## Generate .csv of max intensities for erm-1 in klp-18 KD and L4440 control
...
write_csv(max_intensities, "klp-18_L4440_ch2_max_intensities.csv")
```
...
d <- ggplot(data = foldChange_calc, aes(x = as.factor(channel), y = log(fc_enrich, base = 2), fill = treatment))+
  ...
  scale_fill_manual(values = c("L4440" = "darkgray", "klp-18" = "lightblue"),
                   labels = c("L4440" = "L4440 control", "klp-18" = "klp-18 RNAi"))+
