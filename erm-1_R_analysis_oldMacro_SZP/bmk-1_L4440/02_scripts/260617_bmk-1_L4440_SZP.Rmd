...
d <- ggplot(data = foldChange_calc, aes(x = as.factor(channel), y = log(fc_enrich, base = 2), fill = treatment))+
  ...
  geom_hline(yintercept = 0, linetype = "dashed") +
    scale_fill_manual(values = c("L4440" = "darkgray", "bmk-1-RNAi" = "lightblue"),
                   labels = c("L4440" = "L4440 control", "bmk-1-RNAi" = "bmk-1 RNAi"))+labs(y = "log2 FoldChange Enrichment of mRNA \n(mRNA intensity at 0 / mean mRNA intensity at -100 and 100)", x = "mRNA") +
